        ...
        if (notificationPoint) {
            ...
            if (userEmail) {
                ...
                savedRoutes.forEach((savedRoute) => {
                    if (savedRoute.notificationPoint && savedRoute.notificationPoint.lat === notificationPoint.getLatLng().lat && savedRoute.notificationPoint.lng === notificationPoint.getLatLng().lng) {
